...
function Invitations(): JSX.Element {
    ...
    const getInvitations = () => {
        axios.get('http://localhost/haushaltsapp/Backend/Controllers/invitations/getinvitations.php', { withCredentials: true })
            .then(res => {
    ...
    const handleAcceptInvitation = (e) => {
        ...
        axios.post('http://localhost/haushaltsapp/Backend/Controllers/groups/insertgroupuser.php', obj, { withCredentials: true })
            .then(res => {
