...
function CreateGroup(): JSX.Element {
  ...
  const onSubmit = name => {
    ...
    axios.post('http://localhost/haushaltsapp_backend/creategroup.php', obj, { withCredentials: true })
      .then(res => {
        console.log(res);
  ...
  const onInvitationSubmit = name => {
    ...
    axios.post('http://localhost/haushaltsapp_backend/insertinvitation.php', obj, { withCredentials: true })
      .then(res => {
  ...
  const getGroups = () => {
    axios.get('http://localhost/haushaltsapp_backend/getgroups.php', { withCredentials: true })
      .then(res => {
        setGroups(res.data);
        console.log(groups);
      })
  ...
  const deleteGroup = () => {
    ...
    axios.post('http://localhost/haushaltsapp_backend/deletegroup.php', obj, { withCredentials: true })
      .then(res => {
